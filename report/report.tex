...
The runtime of BFS is O(V+E) where V are the number of vertices and E is the number of edges.\\[1ex]
...
The runtime for DFS is O(V+E) where V are the number of vertices and E is the number of edges. \\[1ex]
